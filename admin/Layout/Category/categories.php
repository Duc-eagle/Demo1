<?php?>
    <div class="d-flex align-items-center pt-2 px-2 py-3 w-100" style="background-color: #c9c2c2">
        <span class="material-symbols-outlined text-primary">home</span><div style="display: inline;color: gray">/ Quản lý danh mục</div>
    </div>

    <div>
        <h2 class="px-3 pt-4" style="color: dimgray">Quản lý danh mục</h2>
    </div>
